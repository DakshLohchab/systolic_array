...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axi_ip_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axi_ip_0 -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/dlohchab/systolic_array/systolic_array.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axi_ip_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
